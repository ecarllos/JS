...
function limpar(){
    ...
    seltab.innerHTML = "" // apaga TODOS os options do select
    res.innerHTML = ""   // apaga todos os itens que aparecem depois dos números serem enviados e cadastrados

    
    let opt = document.createElement("option") 
    opt.innerHTML = "adicione algum número acima" // adiciona um option no select que foi apagado anteriormente nessa mesma função
